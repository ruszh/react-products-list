...
import { SIGNIN, VERIFICATION, SIGNUP, LOGOUT, ALERT_ERROR, ALERT_SUCCESS } from '../../constants';
...
function* verify() {
    try {
        ...
        if(response.error) {
            ...
            return yield call(showAlert, { type: 'error', message: response.error })
        }
...
function* signup(action) {
    try {
        ...
        if(result.success) {
            ...
            return yield call(showAlert, { type: 'success', message: result.success});
        }
